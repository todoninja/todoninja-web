<template>
    <div>
        <div class="flex flex-row items-center font-bold mx-4 mt-4">
            <i @click="$router.back()" class="hero chevron-left solid p-4 -m-4"></i>
            <h1 class="ml-2">Datenschutzerklärung</h1>
        </div>
        <div class="m-8">
            In dieser Datenschutzerklärung informieren wir Sie über die Verarbeitung personenbezogener Daten bei der
            Nutzung dieser Website.
        </div>
        <div class="m-4 p-4 rounded border">
            <div class="font-bold">Verantwortlicher</div>
            <div class="mt-2">
                Verantwortlich für die Datenverarbeitung ist:
                <div class="mt-2">
                    <div>Sebastian Dittrich</div>
                    <div>Bräuergasse 7</div>
                    <div>01067 Dresden</div>
                    <div class="mt-2">Tel: +49 170 6310370</div>
                    <div>Email: sebastian.dittrich@live.de</div>
                </div>
            </div>
        </div>
        <div class="m-4 p-4 rounded border">
            <div class="font-bold">Personenbezogene Daten</div>
            <div class="mt-2">
        ...
        <div class="m-4 p-4 rounded border">
            <div class="font-bold">Daten beim Websiteaufruf</div>
            <div class="mt-2">
                <p>
                    Wenn Sie diese Website nur nutzen, um sich zu informieren und keine Daten angeben, dann verarbeiten
                    wir nur die Daten, die zur Anzeige der Website auf dem von Ihnen verwendeten internetfähigen Gerät
                ...
                <p class="mt-2">
                    Rechtsgrundlage für die Verarbeitung dieser Daten sind berechtigte Interessen gemäß Art. 6 Abs. 1
                    UAbs. 1 Buchstabe f) DSGVO, um die Darstellung der Website grundsätzlich zu ermöglichen.
                </p>
                <p class="mt-2">
        ...
        <div class="m-4 p-4 rounded border">
            <div class="font-bold">Ihre Rechte</div>
            <div class="mt-2">
        ...
        <div class="m-4 p-4 rounded border">
            <div class="font-bold">Einsatz von Cookies</div>
            <div class="mt-2">
                <p>
                    ...
                    Programme ausführen und auch keine Viren auf Ihr Gerät übertragen. Die Stelle, die den Cookie setzt,
                    kann darüber jedoch bestimmte Informationen erhalten. Cookies dienen dazu, das Internetangebot
                    benutzerfreundlicher zu machen. Mithilfe von Cookies kann beispielsweise das Gerät, mit dem diese
                    Website aufgerufen wurde, bei einem erneuten Aufruf erkannt werden.
                </p>
                <p class="mt-2">
                    Durch die Browsereinstellungen lässt sich das Setzen von Cookies einschränken oder verhindern. So
                    kann z. B. nur die Annahme von Cookies, die von Drittanbietern stammen, blockiert werden oder aber
                    auch die Annahme von allen Cookies. Durch das Blockieren sind jedoch möglicherweise nicht mehr alle
                    Funktionen dieser Website nutzbar. Im weiteren Text dieser Datenschutzerklärung informieren wir Sie
                    konkret, an welchen Stellen und zu welchen Zwecken Cookies auf den Seiten zum Einsatz kommen.
                </p>
            </div>
        </div>
        <p class="m-8">
            Quelle:
            <a href="https://www.anwalt.de/vorlage/muster-datenschutzerklaerung.php" rel="nofollow"
